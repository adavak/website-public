...
$s['sourceCode'] = '源代码';
$s['menu'] = '菜单';
$s['websiteDesc'] = '可以轻松地从 Windows Update 服务器下载 UUP 文件。此项目不隶属于 Microsoft Corporation。';
...
$s['uupDumpDesc'] = 'UUP dump 允许你直接从统一更新平台（Unified Update Platform）下载文件，例如 Windows 预览体验计划更新，直接来自 Windows Update。';
$s['uupDumpDescSub'] = '%s 位于 UUP dump。UUP dump 允许你直接从统一更新平台（Unified Update Platform）下载文件，例如 Windows 预览体验计划更新，直接来自 Windows Update。'; //Select language for Windows 11 Insider Preview 25188.1000 (rs_prerelease) amd64 on UUP dump. UUP dump lets you download Unified Update Platform files, like Windows Insider updates, directly from Windows Update.
...
$s['latestDevRelease'] = '最新的 Dev 渠道版本';
$s['latestDevReleaseSub'] = '具有最新功能的版本，运行可能不稳定。<br>适合高度技术性用户。';
$s['latestBetaRelease'] = '最新的 Beta 渠道版本';
...
$s['additionalEditionsInfo'] = '如果你需要可在右侧表格中找到的其他版本，请选择指定的所需版本，然后单击 <i>下一步</i> 按钮。在摘要页面上，你可以在相应的下载选项下选择所需的附加版本。';
...
$s['learnMoreAdditionalEditions2'] = '附加版本的列表由所选的基本版本确定，你可以在下面查看创建附加版本所需的基本版本的列表：';
...
//verification.php
$s['verification'] = '验证';
$s['clickNumberedButton'] = '单击编号为 %d 的按钮';
...
$s['error_UNKNOWN_RING'] = '未知的渠道。';
$s['error_UNKNOWN_FLIGHT'] = '未知的推送版本。';
$s['error_UNKNOWN_COMBINATION'] = '渠道和环的组合不正确。只有预览体验快速环才支持向前跳过。';
...
$s['error_UNSPECIFIED_VE'] = '你尚未选择任何附加版本。如果不想创建附加版本，请选择 <i>使用 aria2 下载并转换</i> 选项。';
